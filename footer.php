...
<!-- BEGIN - RSS Flotante -->
<div class="rrss-flotante">
	<ul class="rrss-flotante__list">
		<li class="rrss-flotante__item">
			<a href="https://www.facebook.com/profile.php?id=100069425921470" class="rrss-flotante__link" target="_blank">
				<i class="fa fa-facebook rrss-flotante__icon"></i>
			</a>
		</li>
		<li class="rrss-flotante__item">
			<a href="https://wa.me/+51988019288?text=Hola,%20quiero%20hablar%20con%20un%20asesor" class="rrss-flotante__link" target="_blank">
				<i class="fa fa-whatsapp rrss-flotante__icon"></i>
			</a>
		</li>
	</ul>
</div>
