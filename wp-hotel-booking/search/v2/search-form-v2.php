...
/**
Formulario derecho de las habitaciones
...
<div id="hotel-booking-search-<?php echo uniqid(); ?>" class="hotel-booking-search">
  ...
  <?php } ?>
  <form <?php echo is_page($page_search) ? 'id="hb-form-search-page" ' : ''; ?> name="hb-search-form" action="<?php echo hb_get_url(); ?>" class="03 hb-search-form-<?php echo esc_attr($uniqid); ?> <?php echo esc_attr($extraclass); ?>">
    <ul class="hb-form-table">
      ...
      <li class="hb-form-field hb-form-number">
        ...
        <div id="adults" class="hb-form-field-input hb_input_field">
          ...
          <span><?php _e('Adults', 'wp-hotel-booking') ?></span>
        </div>
      ...
      <li class="hb-form-field hb-form-number">
        ...
        <div id="child" class="hb-form-field-input hb_input_field">
          ...
          <span><?php _e('Children', 'wp-hotel-booking') ?></span>
        </div>
